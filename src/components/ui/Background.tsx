...
export function Blobs() {
  return (
    <div className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
      <div className="absolute -left-24 top-0 h-72 w-72 rounded-full bg-accent/15 blur-[120px] animate-blob-drift" />
      <div className="absolute right-0 top-32 h-80 w-80 rounded-full bg-indigo-500/10 blur-[120px] animate-blob-drift [animation-delay:-6s]" />
